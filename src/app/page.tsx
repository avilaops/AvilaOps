    ...
    <div className="min-h-screen bg-dark font-roboto text-light overflow-x-hidden">
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-dark via-dark-800 to-dark-900">
        <div className="absolute inset-0 opacity-20">
          ...
          <div className="absolute bottom-1/4 right-1/4 w-48 h-48 sm:w-64 sm:h-64 md:w-96 md:h-96 bg-primary/5 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
        </div>
      </div>
